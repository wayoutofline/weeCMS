 ...
 */
define("DB_HOST", "127.0.0.1"); //change this
define("DB_NAME", "wee-cms"); //change this
...
define("COOKIE_DOMAIN", "localhost");//false); // to be replaced by '.mydomain.com'
define("COOKIE_SECRET_KEY", "1gp@TMPS{+$78sfpMJFe-92s");  //change this
...
define("EMAIL_USE_SMTP", true);
define("EMAIL_SMTP_HOST", "ssl://smtp.gmail.com"); //change this
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "xxxxxxxxxx@gmail.com"); //change this
define("EMAIL_SMTP_PASSWORD", "xxxxxxxxxxxxxxxxxxxx"); //change this
define("EMAIL_SMTP_PORT", 465); //change this if port differs
define("EMAIL_SMTP_ENCRYPTION", "ssl"); //change this if necessary

/**
 * Configuration for: password reset email data
 * Set the absolute URL to password_reset.php, necessary for email password reset links
 */
define("EMAIL_PASSWORDRESET_URL", "http://localhost/sites/packages/wee-cms/password_reset"); //change this 
define("EMAIL_PASSWORDRESET_FROM", "no-reply@weeCMS.wayoutofline.net"); //change this
define("EMAIL_PASSWORDRESET_FROM_NAME", "WeeCMS | Agent");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for WeeCMS");
define("EMAIL_PASSWORDRESET_CONTENT", "Please click on the following link to reset & create a new password: ");

/**
 * Configuration for: verification email data
 * Set the absolute URL to register.php, necessary for email verification links
 */
define("EMAIL_VERIFICATION_URL", "http://localhost/sites/packages/wee-cms/register"); //change this
define("EMAIL_VERIFICATION_FROM", "no-reply@weeCMS.wayoutofline.net"); //change this
define("EMAIL_VERIFICATION_FROM_NAME", "WeeCMS | Agent");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for WeeCMS");
define("EMAIL_VERIFICATION_CONTENT", "Please click on the following link to activate your account: ");
...
define("WORDING_PAGE_SUCCESSFULLY_ADDED", "Page was added successfully.");
define("WORDING_PAGE_SUCCESSFULLY_EDITED", "Page was edited successfully.");
define("WORDING_PAGE_SUCCESSFULLY_DELETED", "Page was deleted successfully.");
define("MESSAGE_PAGETITLE_EMPTY", "Please enter a title.");
define("MESSAGE_PAGECONTENT_EMPTY", "Please enter some content.");
define("MESSAGE_PAGE_ERROR", "Something went wrong. Sorry! :-O");
